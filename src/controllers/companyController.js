...
// render company page
export const companyPage = async function (req, res) {
  try {
...
// allocate interview
export const allocateInterview = async function (req, res) {
  try {
    const students = await Student.find({});
...
// schedule interview
export const scheduleInterview = async function (req, res) {
